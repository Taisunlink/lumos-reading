...
class CaregiverHouseholdReadService:
    ...
    def get_household(self, household_id: UUID) -> CaregiverHouseholdV1:
        ...
        featured_package = package_map.get(household.featured_package_id) or self.story_package_service.get_story_package(
        ...
        return CaregiverHouseholdV1(
            ...
            featured_package_id=household.featured_package_id,
