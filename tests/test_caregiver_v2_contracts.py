...
def test_contract_schema_files_exist() -> None:
    expected_files = [
        ...
        "story-brief-command.v1.schema.json",
        "story-brief.v1.schema.json",
        "story-brief-index.v1.schema.json",
        "story-generation-job-command.v1.schema.json",
        "story-generation-job.v1.schema.json",
        "story-generation-job-index.v1.schema.json",
        ...
        "story-package-review-command.v1.schema.json",
